...
import static com.example.tysgrocery.Beverages.MSG;
...
//                    final String txt_product_number = product_number.getText().toString();
                    DocumentReference documentReference = fstore.collection("Beverages").document(txt_product).collection("Product No.").document(txt_product);
